...
$(BIN)/$(EXECUTABLE): $(SRC)/*.cpp $(SRC)/*.h $(SRC)/cli/*.h
	$(CXX) $(CXX_FLAGS) -I $(INCLUDE) -I ./src -L $(LIB) $(SRC)/main.cpp  $(SRC)/repository.cpp  $(SRC)/imperium_object.cpp $(SRC)/blob_object.cpp $(SRC)/tree_object.cpp -o $ $(BIN)/$(EXECUTABLE) $(LIBRARIES)
